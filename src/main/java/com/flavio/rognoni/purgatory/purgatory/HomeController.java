...
//    private MazeSquare[] teles;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        renderSpinner(hSpinner, Maze.MIN_DIM, Maze.MAX_DIM);
        renderSpinner(wSpinner, Maze.MIN_DIM, Maze.MAX_DIM);
        renderSpinner(sxSpinner, 1, Maze.MAX_DIM-2);
        renderSpinner(sySpinner, 1, Maze.MAX_DIM-2);
